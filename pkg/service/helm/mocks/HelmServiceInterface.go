...
import "github.com/softplan/tenkai-api/pkg/dbms/model"
import "sync"
...
func (_m *HelmServiceInterface) GetHelmReleaseHistory(kubeconfig string, releaseName string) (helmapi2.ReleaseHistory, error) {
	ret := _m.Called(kubeconfig, releaseName)

	var r0 helmapi2.ReleaseHistory
	if rf, ok := ret.Get(0).(func(string, string) helmapi2.ReleaseHistory); ok {
		r0 = rf(kubeconfig, releaseName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(helmapi2.ReleaseHistory)
		}
	}
...
func (_m *HelmServiceInterface) ListHelmDeployments(kubeconfig string, namespace string) (*helmapi2.HelmListResult, error) {
	ret := _m.Called(kubeconfig, namespace)

	var r0 *helmapi2.HelmListResult
	if rf, ok := ret.Get(0).(func(string, string) *helmapi2.HelmListResult); ok {
		r0 = rf(kubeconfig, namespace)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*helmapi2.HelmListResult)
		}
	}
