...
func ElkClient(url string, username string, password string) (*elastic.Client, error) {
...
func DoAudit(ctx context.Context, client *elastic.Client, username string, operation string, values map[string]string) {
